    ...
    return (
        <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <div className="flex items-center justify-center w-full -mt-40 z-20">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 max-w-7xl rounded-lg lg:rounded-2xl border border-border/80 py-4 md:py-8">
                        ...
                        <div className="flex flex-col items-start gap-2 md:min-w-80 mt-5 md:mt-0">
                            <div className="flex flex-col md:flex-row items-center gap-2 w-full md:max-w-xs">
                                <Input
                                    required
                                    type="email"
                                    placeholder="Enter your email"
                                    className="focus-visible:ring-0 focus-visible:ring-transparent focus-visible:border-primary duration-300"
                                />
                                <Button size="sm" variant="secondary" className="w-full md:w-max">
                                    Subscribe
                                </Button>
                            </div>
